...
class _HomeItemScreenState extends State<HomeItemScreen> {
  ...
  Widget build(BuildContext context) {
    print("iteemmmmmmm"+widget.index.toString());
    return SafeArea(
      child:Scaffold (
            ...
            child: BlocConsumer<ItemTapBloc, ItemTapState>(
              ...
              builder: (context, state) {
                if (state is ItemTapLoadingtate) {
                  return BlocProvider(
                    create: (context) =>
                        AddItemBloc(state.homeitemdata[widget.index!].index),
                    child: Column(
                      ...
                      children: [
                        Stack(clipBehavior: Clip.none,
                          children: [
                            Image.network(
                              state.homeitemdata[widget.index!]?["images"] ?? "",
                              fit: BoxFit.contain,
                            ),
                            Positioned(
                              top: 10,
...
// context.read<ItemTapBloc>().likeItem();
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: Dimensions.dimen15,top:Dimensions.dimen15,right: Dimensions.dimen15),
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  TextWidget(
                                    title: state.homeitemdata[widget.index!]?['food_title'] ?? "",
                                    fontSize: 25,
                              ...
                              Row(
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: TextWidget(
                                      title: state.homeitemdata[widget.index!]?['ratings'] ?? "",
                              ...
                              Row(
                                children: [
                                  const Icon(Icons.local_pizza, color: Colors.green, size: 20),
                                  Padding(
                                    padding: const EdgeInsets.only(left: 5),
                                    child: TextWidget(
                                      title: state.homeitemdata[widget.index!]?['distance'] ?? "",
                                      titleColor: AppColor.blackColor,
                                      fontSize: AppFontWeight.font17,
                                      fontWeight: FontWeight.bold,
                                    ),
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: TextWidget(
                                        title:
                                        state.homeitemdata[widget.index!]?['delivery_charges'] ?? "",
                                        titleColor: AppColor.greyColor,
                                        fontSize: AppFontWeight.font12,
                                        fontWeight: FontWeight.w700,
                                      ),
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    double price =
                                        state.homeitemdata[index]["price"] as double? ??
                                            0.0;
                                    if (isCardTapped) {
                                      ...
                                      i++) {
                                        if (_selectedMenuIndex == i) {
                                          totalPrice +=
                                              state.homeitemdata[i]["price"] as double? ??
                                                  0.0;
                                        }
                                      }
                                    }
...
//height: 4,
                              ...
                              Container(
                                margin: const EdgeInsets.only(top: Dimensions.dimen10, bottom: Dimensions.dimen20,),
                                width: MediaQuery.of(context).size.width,
                                height: 50,
                                child: ElevatedButton(
                                    ...
                                    onPressed: () {
                                     Navigator.pushNamed(context, CheckoutOrderScreen.routeName, arguments: _selectedDrinkIndex);
                                    },
                                    child: Center(
                                      child: TextWidget(
                                        title:
