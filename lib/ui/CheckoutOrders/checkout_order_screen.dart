                        ...
                        child: BlocConsumer<CheckoutBloc,CheckoutState>(
                          listener: (context,state){
                            if(state is CheckoutAddressTapState){
                              print("ssss");
                              print(state);
                              Navigator.pushNamed(context, DeliverAddressScreen.routeName).then((value)  {
                                index=value as int;
                              });
                            }
                          },
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      for(int i=0;i<data.length;i++)
                      Container(
                        padding: EdgeInsets.only(bottom: Paddings.padding10),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(14),
                          border:
                              Border.all(color: AppColor.whiteColor, width: 3),
                        ),
                        child: Row(
                          children: [
                            ClipRRect(
                  ...
                  child: Column(
                    children: [
                      InkWell(
                        ...
                        onTap: () {
                          _checkoutBloc.add(PaymentTapEvent(context));
                        },
                      ),
                      Divider(
                          thickness: 2,
                      ...
                      InkWell(
                        onTap: () {
                          _checkoutBloc.add(GetDiscountsTapEvent(context));
                        },
                        child: const Row(
                          children: [
                            Padding(
                    ...
                    child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          ...
                          backgroundColor: AppColor
                              .greenColor, // Set the button's text color
